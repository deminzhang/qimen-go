...
// 贵人(天乙)昼夜: 歌诀「甲戊庚牛羊 / 乙己鼠猴乡 / 丙丁猪鸡位 / 壬癸兔蛇藏 / 六辛逢马虎」
// 每句前支为昼贵(c1, 卯→申时用), 后支为夜贵(c2, 酉→寅时用)
func guiren(gan, hourZhi string) ShenShaItem {
	c1 := map[string]string{"甲": "丑", "戊": "丑", "庚": "丑", "乙": "子", "己": "子", "丙": "亥", "丁": "亥", "壬": "卯", "癸": "卯", "辛": "午"}
	c2 := map[string]string{"甲": "未", "戊": "未", "庚": "未", "乙": "申", "己": "申", "丙": "酉", "丁": "酉", "壬": "巳", "癸": "巳", "辛": "寅"}
