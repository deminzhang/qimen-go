...
func (g *EightCharPan) Draw(screen *ebiten.Image) {
	...
	text.Draw(screen, p.Year.Body, ft14, int(sx), int(sy+48), ColorGanZhi(p.Year.Body))
	text.Draw(screen, ShiShenShort(soul, p.Year.Body), ft14, int(sx+16), int(sy+48), colorWhite)
	text.Draw(screen, p.Year.Legs, ft14, int(sx), int(sy+64), ColorGanZhi(p.Year.Legs))
	text.Draw(screen, ShiShenShort(soul, p.Year.Legs), ft14, int(sx+16), int(sy+64), colorWhite)
	text.Draw(screen, p.Year.Feet, ft14, int(sx), int(sy+80), ColorGanZhi(p.Year.Feet))
	text.Draw(screen, ShiShenShort(soul, p.Year.Feet), ft14, int(sx+16), int(sy+80), colorWhite)
	text.Draw(screen, LunarUtil.NAYIN[bz.GetYear()], ft14, int(sx), int(sy+96), ColorNaYin(bz.GetYear()))
	...
	text.Draw(screen, p.Month.Body, ft14, int(sx), int(sy+48), ColorGanZhi(p.Month.Body))
	text.Draw(screen, ShiShenShort(soul, p.Month.Body), ft14, int(sx+16), int(sy+48), colorWhite)
	text.Draw(screen, p.Month.Legs, ft14, int(sx), int(sy+64), ColorGanZhi(p.Month.Legs))
	text.Draw(screen, ShiShenShort(soul, p.Month.Legs), ft14, int(sx+16), int(sy+64), colorWhite)
	text.Draw(screen, p.Month.Feet, ft14, int(sx), int(sy+80), ColorGanZhi(p.Month.Feet))
	text.Draw(screen, ShiShenShort(soul, p.Month.Feet), ft14, int(sx+16), int(sy+80), colorWhite)
	text.Draw(screen, LunarUtil.NAYIN[bz.GetMonth()], ft14, int(sx), int(sy+96), ColorNaYin(bz.GetMonth()))
	...
	text.Draw(screen, p.Day.Body, ft14, int(sx), int(sy+48), ColorGanZhi(p.Day.Body))
	text.Draw(screen, ShiShenShort(soul, p.Day.Body), ft14, int(sx+16), int(sy+48), colorWhite)
	text.Draw(screen, p.Day.Legs, ft14, int(sx), int(sy+64), ColorGanZhi(p.Day.Legs))
	text.Draw(screen, ShiShenShort(soul, p.Day.Legs), ft14, int(sx+16), int(sy+64), colorWhite)
	text.Draw(screen, p.Day.Feet, ft14, int(sx), int(sy+80), ColorGanZhi(p.Day.Feet))
	text.Draw(screen, ShiShenShort(soul, p.Day.Feet), ft14, int(sx+16), int(sy+80), colorWhite)
	text.Draw(screen, LunarUtil.NAYIN[bz.GetDay()], ft14, int(sx), int(sy+96), ColorNaYin(bz.GetDay()))
	...
	text.Draw(screen, p.Time.Body, ft14, int(sx), int(sy+48), ColorGanZhi(p.Time.Body))
	text.Draw(screen, ShiShenShort(soul, p.Time.Body), ft14, int(sx+16), int(sy+48), colorWhite)
	text.Draw(screen, p.Time.Legs, ft14, int(sx), int(sy+64), ColorGanZhi(p.Time.Legs))
	text.Draw(screen, ShiShenShort(soul, p.Time.Legs), ft14, int(sx+16), int(sy+64), colorWhite)
	text.Draw(screen, p.Time.Feet, ft14, int(sx), int(sy+80), ColorGanZhi(p.Time.Feet))
	text.Draw(screen, ShiShenShort(soul, p.Time.Feet), ft14, int(sx+16), int(sy+80), colorWhite)
	text.Draw(screen, LunarUtil.NAYIN[bz.GetTime()], ft14, int(sx), int(sy+96), ColorNaYin(bz.GetTime()))
